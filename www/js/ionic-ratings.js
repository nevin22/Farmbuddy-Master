  ...
  function ionicRatings() {
    return {
      ...
      template: '<div class="text-center ionic_ratings">' +
        ...
        '<span class="icon {{iconOn}} ionic_rating_icon_on" ng-stye="iconOnColor" ng-click="ratingsUnClicked(1)" ng-if="rating > 0" ng-class="{\'read_only\':(readOnly)}"></span>' +
      ...
      link: function(scope, element, attrs) {
        ...
        scope.iconOffColor = scope.ratingsObj.iconOffColor || 'rgb(184, 231, 175)';
